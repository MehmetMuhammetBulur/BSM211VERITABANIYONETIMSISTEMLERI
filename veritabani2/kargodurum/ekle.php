...
try{
 ...
 if($gad1!="" ){
$query=$conn->exec("insert into kargo_durum (kargo_durum_ad) VALUES('$gad1')");
if($query)
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Kargo durum Ekle</h1>
                    </div>
...
?>
  ...
  <input type="hidden" value="" id="garson_id" name="id">
    ...
    <label for="fname">Durum adı</label>
    <input type="text" id="fname" name="gad"  placeholder="Durum">
