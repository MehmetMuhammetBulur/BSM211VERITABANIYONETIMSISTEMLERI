...
try{
 ...
 if($_POST) 
		...
		if($sonuc = $conn ->query("DELETE FROM kargo_iade WHERE kargo_iade_id=$id")==true){
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Kargo iade sil</h1>
                    </div>
...
<th style='text-align:center;'>İade nedeni</th>
...
echo "<form form action='sil.php' method='post'><td style='text-align:center;'> <input type='hidden' name='id'value='".$row['kargo_iade_id']."'> <input type='submit'value='Sil' ></form>";
}
