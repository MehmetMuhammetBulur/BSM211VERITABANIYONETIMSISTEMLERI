...
try{
 ...
 if($gad!="" ){
$query=$conn->exec("insert into kargo_alim (alim_adres) VALUES('$gad')");
if($query)
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Alınıcak kargo Ekle</h1>
                    </div>
...
?>
  ...
  <input type="hidden" value="" id="garson_id" name="id">
    <label for="fname">Alım adresi adı</label>
    <input type="text" id="fname" name="gad"  placeholder="Alım adresi">
