...
try{
 ...
 if($gad1!="" ){
$query=$conn->exec("insert into kargo_takip (kargo_id,takip_nerede) VALUES('$gad','$gad1')");
if($query)
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Kargo çıkışı Ekle</h1>
                    </div>
...
?>
  ...
  <input type="hidden" value="" id="garson_id" name="id">
    ...
    <label for="kateg">Kargo adı</label>
...
while ($row = $query->fetch()) {
  echo "<option value=".$row['kargo_id']." selected>".$row['kargo_ad']."</option>";
   ...
   ?>
    ...
    <label for="fname">Nereye çıktı</label>
    <input type="text" id="fname" name="gad"  placeholder="Adres">
