...
try{
 ...
 if($_POST){
  ...
  if($garson_id!="" && $garson_ad!=""){
    $sonuc = $conn->exec("UPDATE kargo SET  kargo_ad ='$garson_ad' , katag_id ='$katag_id' , mal_id ='$markas_id' , kargo_sahip ='$fiyat'  WHERE kargo_id='$garson_id'");
  }else{
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Urun Kargo düzenle</h1>
                    </div>
...
<div class="table-responsive">
  ...
  <th style='text-align:center;'>Kargo sahibi</th>
...
try{
 ...
 $query = $conn->query("SELECT * FROM kargo inner join kategori on (kat_id=katag_id) inner join mal on(mal.mal_id=kargo.mal_id)");

 while ($row = $query->fetch()) {
  echo "<tr ><td style='text-align:center;'>".$row['kargo_ad']."</td>";
  echo "<td style='text-align:center;'>".$row['kat_ad']."</td>";
  echo "<td style='text-align:center;'>".$row['mal_ad']."</td>";
  echo "<td style='text-align:center;'>".$row['kargo_sahip']."</td>";
    echo "<td style='text-align:center;'> <button class='urunduzen' id=".$row['kargo_id'].">Düzenle</button>";
}
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Urun duzenle</h5>
  ...
  <input type="hidden" value="" id="garson_id" name="id">
    ...
    <label for="tur">Mal Miktari/adı</label>
    <select  id="tur" name="tur">
    </select>
    <label for="fiyat">Kargo Sahibi</label>
    <input type="text" id="fiyat" name="fiyat"  placeholder="Urun sahibi" readonly>
